...
# Meter Amer-Indian-Eskimo, Asian y Other

# User target mean (mirar si tiene sentido agrupación)
tapply(df$`hours-per-week`,df$race,mean)


# Crear factores agrupando para race
...
# ll<-which(df$race %in% c("Amer-Indian-Eskimo","Asian-Pac-Islander","Other"));length(ll)
# df$race.type[ll]<-4

# Check
paste0("race-",c("Other","White","Black"))
